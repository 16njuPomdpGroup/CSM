...
\ref{fig:agent_adr_time}).

\begin{figure}[tbp]
	\centering
	\subfloat[Tiger Grid]{\includegraphics[width=3in]{sample_adr_time.png}}\\
  \subfloat[Hallway]{\includegraphics[width=3in]{sample_adr_time.png}}\\
  \subfloat[McCallum]{\includegraphics[width=3in]{sample_adr_time.png}}\\
  \subfloat[Prim]{\includegraphics[width=3in]{sample_adr_time.png}}\\
